      ...
      <main style={{ display: 'flex', flexDirection: 'column' }}>
        <Box w="100%" position="relative">
          ...
          <Box top={0} position="absolute" width="100%" height="100%" display="flex" justifyContent="center" alignItems="center" background="rgba(0, 0, 0, 0.5)">
            ...
            <Text as="i" position="absolute" bottom="0" right="0" color="whiteAlpha.900" fontSize="xs">Image by Richard Kidger via <a href="https://unsplash.com/photos/V4S9FZmvYvM" target="_blank">https://unsplash.com/photos/V4S9FZmvYvM</a> Copyright Free</Text>
          </Box>
        </Box>
